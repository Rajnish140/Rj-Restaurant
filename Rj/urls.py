...
urlpatterns = [
    ...
    path('login_p/',views.login_page,name="manager"),
    ...
    #path('customerdata/',views.customer_details,name="customer_data"),
    path('bill_p/',views.customer_details,name="customerdata"),
